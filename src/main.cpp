        ...
        if (event == "telemetry") {
          ...
          */
          ...
          for (size_t i = 0; i < n_waypoints; i++ ) {
            ...
            ptsx_trans(i) = dX * cos(minus_psi) - dY * sin(minus_psi);
            ptsy_trans(i) = dX * sin(minus_psi) + dY * cos(minus_psi);
          }
          ...
          double steer_value = solutions[0];
          ...
          for (size_t i = 2; i < solutions.size(); ++i) {
            if (i % 2 == 0) {
